...
const RESOURCES = {
    en: {
        ...
        'vite.instructions_full': '[vite-dev] 🔁 Press r to rebuild JS, m to repackage manifest, u for full rebuild, q to quit',
        'vite.rebuild_manual_js': '[vite-dev] 🔁 Rebuild JS triggered...',
        'vite.rebuild_manual_manifest': '[vite-dev] 📋 Manifest repackage/re-upload triggered...',
    ...
    'zh-CN': {
        ...
        'vite.instructions_full': '[vite-dev] 🔁 按 r 立即重建JS，按 m 仅重打包manifest，按 u 全量重建，按 q 退出',
        'vite.rebuild_manual_js': '[vite-dev] 🔁 已触发 JS 重建...',
        'vite.rebuild_manual_manifest': '[vite-dev] 📋 已触发 Manifest 重打包/重上传...',
    ...
    'zh-TW': {
        ...
        'vite.instructions_full': '[vite-dev] 🔁 按 r 立即重建JS，按 m 僅重打包manifest，按 u 全量重建，按 q 退出',
        'vite.rebuild_manual_js': '[vite-dev] 🔁 已觸發 JS 重建...',
        'vite.rebuild_manual_manifest': '[vite-dev] 📋 已觸發 Manifest 重打包/重上傳...',
    ...
    'ja': {
        ...
        'vite.instructions_full': '[vite-dev] 🔁 r: JS再ビルド, m: Manifest再パッケージ, u: フル再ビルド, q: 終了',
        'vite.rebuild_manual_js': '[vite-dev] 🔁 JS再ビルドを開始します...',
        'vite.rebuild_manual_manifest': '[vite-dev] 📋 Manifest再パッケージ/再アップロードを開始します...',
