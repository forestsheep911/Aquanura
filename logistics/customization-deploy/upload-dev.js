...
(async () => {
    ...
    try {
        ...
        // The uploader runs relative to the manifest file location usually.
        // My manifest has "customization/dist/index.js".
        // If I put TEMP_MANIFEST in logistics/customization-deploy/, 
        // then "customization/dist/index.js" (which is in root/customization...) 
        // needs to be resolved correctly.
        // "customization" is at ../../customization
        ...
        console.log(chalk.cyan(`Uploading to App ID: ${appId} on ${baseUrl}...`));

        // Construct command
        // We use the local bin from node_modules
